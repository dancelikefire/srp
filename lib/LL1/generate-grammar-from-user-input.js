...
let Grammar =require('../tool/grammar')
    ...
    for (let i = 0; i < this.productions.length; i++) {
      ...
      for (let j = 1; j < this.productions[i].length; j++) {
        ...
        for (let k = 0; k < this.productions[i][j].length; k++) {
          // console.log(this.productions[i][j][k].symbol)
          // console.log(this.productions[i][j][k].type)
...
module.exports= function(productions, startSign) {
